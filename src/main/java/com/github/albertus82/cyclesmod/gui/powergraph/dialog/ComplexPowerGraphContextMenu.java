package com.github.albertus82.cyclesmod.gui.powergraph.dialog;
...
import com.github.albertus82.cyclesmod.gui.powergraph.PowerGraphContextMenu;
import com.github.albertus82.cyclesmod.gui.powergraph.dialog.listener.RedoListener;
import com.github.albertus82.cyclesmod.gui.powergraph.dialog.listener.SaveSnapshotListener;
import com.github.albertus82.cyclesmod.gui.powergraph.dialog.listener.UndoListener;
import com.github.albertus82.cyclesmod.gui.powergraph.dialog.listener.ZoomInListener;
import com.github.albertus82.cyclesmod.gui.powergraph.dialog.listener.ZoomOutListener;
...
public class ComplexPowerGraphContextMenu extends PowerGraphContextMenu {
	...
	public ComplexPowerGraphContextMenu(final Control control, final IPowerGraph powerGraph) {
		...
		saveImageMenuItem.setText(messages.get("gui.label.menu.item.graph.saveImageAs") + SwtUtils.getMod1ShortcutLabel(SwtUtils.KEY_SAVE));
		...
		autoScaleMenuItem.setText(messages.get("gui.label.menu.item.graph.autoscaling"));
		...
		zoomInMenuItem.setText(messages.get("gui.label.menu.item.graph.zoomIn") + SwtUtils.getShortcutLabel("+"));
		...
		zoomOutMenuItem.setText(messages.get("gui.label.menu.item.graph.zoomOut") + SwtUtils.getShortcutLabel("-"));
		...
		performAutoScaleMenuItem.setText(messages.get("gui.label.menu.item.graph.autoscaleNow"));
		...
		control.addMenuDetectListener(e -> {
			...
			if (manager.getUndoCommandsSize() > 0) {
				...
				undoMenuItem.setText(messages.get("gui.label.menu.item.graph.undo", cmdName) + SwtUtils.getMod1ShortcutLabel(SwtUtils.KEY_UNDO));
			}
			else {
				undoMenuItem.setEnabled(false);
				undoMenuItem.setImage(imageUndoGray);
				undoMenuItem.setText(messages.get("gui.label.menu.item.graph.undo", "") + SwtUtils.getMod1ShortcutLabel(SwtUtils.KEY_UNDO));
			}
			if (manager.getRedoCommandsSize() > 0) {
				...
				redoMenuItem.setText(messages.get("gui.label.menu.item.graph.redo", cmdName) + SwtUtils.getMod1ShortcutLabel(SwtUtils.KEY_REDO));
			}
			else {
				redoMenuItem.setEnabled(false);
				redoMenuItem.setImage(imageRedoGray);
				redoMenuItem.setText(messages.get("gui.label.menu.item.graph.redo", "") + SwtUtils.getMod1ShortcutLabel(SwtUtils.KEY_REDO));
			}
