...
public class TorqueGraphMouseListener implements MouseListener {
	...
	public TorqueGraphMouseListener(final TorqueGraph graph, final Map<String, FormProperty> formProperties, final NumeralSystemProvider numeralSystemProvider) {
