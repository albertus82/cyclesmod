...
* **Regime inizio zona rossa**: regime oltre il quale, dopo un tempo variabile configurabile, si verifica la rottura del motore. Intervallo di valori validi: `8500`-`32767`.
